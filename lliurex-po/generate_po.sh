...
xgettext --join-existing -kde -ki18nd:2 ../lliurex-shutdowner.install/usr/share/lliurex-shutdowner/rsrc/TimeSelector.qml -o lliurex-shutdowner/lliurex-shutdowner.pot
