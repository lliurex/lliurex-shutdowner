from PySide2.QtCore import QObject,Signal,Slot,QThread,Property,QTimer,QUrl
...
class Bridge(QObject):
	...
	@Property('QVariant',notify=showMessageChanged)
	...
	@Property('QVariant', notify=isThereAnErrorChanged)
